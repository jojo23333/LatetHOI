...
from d2.utils.testing import flatten_results_dict
from d2.utils.events import EventStorage, EventWriter
...
class LRScheduler(HookBase):
    ...
    def before_train(self):
        ...
        if isinstance(self.scheduler, ParamScheduler):
            raise NotImplementedError("Deprecated for simplicity. See Detectron2.")

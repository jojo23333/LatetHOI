...
def nested_tensor_to_numpy(obj):
    print(type(obj))
    if isinstance(obj, dict):
        return {key: nested_tensor_to_numpy(value) for key, value in obj.items()}
    elif isinstance(obj, list):
        return [nested_tensor_to_numpy(element) for element in obj]

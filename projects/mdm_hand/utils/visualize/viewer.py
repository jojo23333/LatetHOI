...
class Viewer(moderngl_window.WindowConfig):
    if getattr(sys, 'frozen', False):
        ...
        resource_dir = Path(base_path) / "utils/visualize/shaders"
        font_dir = Path(base_path) / "utils/visualize/resources/fonts"
    else:
        from aitviewer import viewer as v
        import inspect
        module_file_path = inspect.getfile(v)
        resource_dir = Path(module_file_path).parent / "shaders"
        font_dir = Path(module_file_path).parent / "resources" / "fonts"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # try:
        #     icon_path = os.path.join(os.path.dirname(self.module_file_path), "..", "assets", "aitviewer_icon.png")
        ...
        self.open_file_handler = kwargs['open_file_handler']
    ...
    def gui_menu(self):
        ...
        if imgui.begin_main_menu_bar():
            if imgui.begin_menu("File", True):
                ...
                clicked_open_file, selected_open = imgui.menu_item("Open New File", None, False, True)
